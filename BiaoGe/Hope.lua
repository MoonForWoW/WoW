        ...
        for b = 1, HopeMaxb[FB], 1 do
            ...
            for i = 1, HopeMaxi, 1 do
                ...
                do
                    ...
                    BG.HopeFrameDs[FB..1]["nandu"..n]["boss"..b]["ds"..i] = TextureDs[FB..1]
                        -- 底色材质2（点击框体后）
                    local ds = CreateFrame("Button", nil, BG["HopeFrame"..FB])
                    ds:SetSize(152, 18)
                    ...
                    BG.HopeFrameDs[FB..2]["nandu"..n]["boss"..b]["ds"..i] = TextureDs[FB..2]
                    ...
                    BG.HopeFrameDs[FB..3]["nandu"..n]["boss"..b]["ds"..i] = TextureDs[FB..3]
                end
                ------------------装备------------------
                do
                    ...
                    button:SetScript("OnEnter", function(self) 
                        BG.HopeFrameDs[FB..1]["nandu"..n]["boss"..b]["ds"..i]:SetColorTexture(red,greed,blue,touming1)
                        if not tonumber(self:GetText()) then
                    ...
                    button:SetScript("OnLeave", function(self) 
                        BG.HopeFrameDs[FB..1]["nandu"..n]["boss"..b]["ds"..i]:SetColorTexture(0,0,0,0)
                        GameTooltip:Hide()
                    end)
                        -- 获得光标时
                    button:SetScript("OnEditFocusGained", function(self)
                        ...
                        BG.HopeFrameDs[FB..2]["nandu"..n]["boss"..b]["ds"..i]:SetColorTexture(red,greed,blue,touming2)    -- 底色
                    end)
                        -- 失去光标时
                    button:SetScript("OnEditFocusLost", function(self)
                        ...
                        BG.HopeFrameDs[FB..2]["nandu"..n]["boss"..b]["ds"..i]:SetColorTexture(0,0,0,0)
                    end)
                        -- 按TAB跳转右边
